...
$Date=date('Y-m-d');
$Cinema= $_POST['Cinema'];
$result = mysql_query("SELECT ticketnum FROM cinema1");
...
mysql_query("UPDATE  cinema1 SET  ticketnum =  '$number' WHERE  `cinema1`.`No` =1;");
...
<BR><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 5px; color: yellow;"><span style="font-family: Berlin Sans FB Demi; font-size: 30px; text-align: center; color: red; font-weight: bold;"><span style="text-align: center; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-family: Berlin Sans FB Demi; font-size: 18px; color: yellow;">Costumer
  Name:</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  <input name="cname" style="padding: 5px 10px; width: 210px;" type="text" required="required">
  &nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 5px; color: yellow;"><span class="style1">No. of tickets:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 5px; color: yellow;">&nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 5px; color: yellow;"><br>
...
?>">
  &nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 5px; color: yellow;"><span class="style3">Price: &nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<p style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="submits" value="Reserve Movie" type="submit">
</p>
</form>

</div>
<div class="right">
<img alt="" style="width: 201px; height: 146px; float: left;" src="pics/background/rose.jpg">
<?php
include('conn.php');
$query=mysql_query("SELECT * FROM `cinema1`");
{
...
<div class="right">
<img alt="" style="width: 201px; height: 146px; float: left;" src="pics/background/field.jpg">
<?php
include('conn.php');
