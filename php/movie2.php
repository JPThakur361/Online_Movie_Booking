...
<div class="mid">
  <p style="font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 30px; text-align: center; color: yellow;"><big><big>Movie Description</big></big></p>
...
$Date=date('Y-m-d');
$Cinema= $_POST['Cinema'];
$result = mysql_query("SELECT ticketnum FROM cinema2");
...
mysql_query("UPDATE  cinema2 SET  ticketnum =  '$number' WHERE  `cinema2`.`No` =1;");
