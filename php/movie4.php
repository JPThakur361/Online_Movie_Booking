...
$Date=date('Y-m-d');
$Cinema= $_POST['Cinema'];
$result = mysql_query("SELECT ticketnum FROM cinema4");
...
mysql_query("UPDATE  cinema4 SET  ticketnum =  '$number' WHERE  `cinema4`.`No` =1;");
...
of Movie:
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Title" style="padding: 5px 10px; width: 210px;" readonly type="text" value="
 <?php
include('conn.php');
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cinemas:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Cinema" style="padding: 5px 10px; width: 210px;" readonly type="text" value="Cinema 4">
</p>
