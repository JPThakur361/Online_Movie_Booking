...
$Date=date('Y-m-d');
$Cinema= $_POST['Cinema'];
$result = mysql_query("SELECT ticketnum FROM cinema5");
...
mysql_query("UPDATE  cinema5 SET  ticketnum =  '$number' WHERE  `cinema5`.`No` =1;");
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">Costumer
  ...
  &nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;"><span style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">No. of tickets:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="text-align: center;">
...
of Movie:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Title" style="padding: 5px 10px; width: 210px; height:15px" readonly type="text" value="
 <?php
include('conn.php');
...
?>">
   &nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;"><span class="style3">Price: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cinemas:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Cinema" style="padding: 5px 10px; width: 210px;" readonly type="text" value="Cinema 5">
</p>
<p style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="submits" value="Reserve Movie" type="submit">
</p>
</form>
</div>
<div class="right"><img alt="" style="float: left; width: 201px; height: 146px;" src="pics/background/rose.jpg">
<?php
include('conn.php');
...
$query=mysql_query("SELECT * FROM `cinema3`");
{
	...
	?></div>
<div class="right">
<img src="pics/background/field.jpg" alt="" style="width: 201px; height: 146px; float: left;">
<?php
include('conn.php');
