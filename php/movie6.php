...
$Date=date('Y-m-d');
$Cinema= $_POST['Cinema'];
$result = mysql_query("SELECT ticketnum FROM cinema6");
...
mysql_query("UPDATE  cinema6 SET  ticketnum =  '$number' WHERE  `cinema6`.`No` =1;");
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">Costumer
  ...
  &nbsp;</p>
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 30px; color: yellow;"><span style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">No. of tickets:</span><span style="text-align: center;">
...
of Movie:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Title"  readonly type="text" style="padding: 5px 10px; width: 210px; height:15px" value="
 <?php
include('conn.php');
...
<p style="text-align: center; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 18px; color: yellow;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cinemas:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input name="Cinema" style="padding: 5px 10px; width: 210px;" readonly type="text" value="Cinema 6">
</p>
<p style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="submits" value="Reserve Movie" type="submit">
</p>
</form>
</div>
<div class="right"><img src="pics/background/rose.jpg" alt="" style="width: 201px; height: 146px; float: left;">
<?php
include('conn.php');
